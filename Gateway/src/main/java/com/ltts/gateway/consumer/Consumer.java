...
public class Consumer implements ChannelAwareMessageListener{
	...
	System.out.println("Received <" + message + ">");
		...
		byte[] body = message.getBody();
          ...
          OutputStreamWriter output1=new OutputStreamWriter(conn.getOutputStream());
          System.out.println(receive);
          output1.write(receive.toString());
          conn.connect();
			
			  String output2=conn.getResponseMessage(); System.out.println(output2);
	}
